...
\\ \indent Para ilustra mejor la interacción entre los componentes involucrados se presenta el diagrama de secuencias:
\begin{figure}[htb]
\centering
\includegraphics[width=.8\textwidth]{img/diagrama-secuencia.png}
\caption{Diagrama de Secuencia} \label{fig:diagrama-secuencia}
\end{figure}
